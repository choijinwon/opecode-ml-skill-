...
def main() -> None:
    ...
    from design_agent_core.prompts import PROMPT_NAME, SYSTEM_PROMPT, USER_PROMPT_TEMPLATE
    ...
    prompt = genai.register_prompt(
        ...
        commit_message="디자인 에이전트 기본 프롬프트 등록",
    )
    try:
    ...
    (ARTIFACTS_DIR / "design_prompt_registered.txt").write_text(
