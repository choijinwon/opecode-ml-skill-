...
def register_model():
    ...
    registered_model_name = mlflow_register_model_name or config.get("registered_model_name", "tensorflow-sample-model")
...
def main():
    parser = argparse.ArgumentParser(description="AI Studio style TensorFlow MLflow sample")
