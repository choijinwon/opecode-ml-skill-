...
selected_model_path = normalize_upload_uri(os.path.join(project_dir, selected_model_relative_path))
model_kind = {kind!r}
...
with mlflow.start_run(run_name=mlflow_register_model_name) as run:
    ...
    model_path = normalize_upload_uri(os.path.join(model_dir, os.path.basename(selected_model_path)))
