...
def main() -> int:
    ...
    if model_found:
        ...
        print("  - aiu_studio/는 실행 템플릿 폴더만 복사하고, 모델 파일은 복사하지 않습니다.")
        print("  - 선택한 모델 기준으로 runtest.py를 우선 참조하고, 없으면 run_test.py를 참조하세요.")
        print("  - 선택 모델 형식에 맞게 runtest_2.py를 변환 생성하세요.")
